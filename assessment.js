...
function removeThings(arrayOfThings, thing) {
	for (var i = arrayOfThings.length; i >= 0; i--) {
		if (arrayOfThings[i] === thing) {
...
function getPropertyValue(obj, objPropAsString) {
	return obj[objPropAsString];
}
